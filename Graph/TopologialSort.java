...
public class TopologialSort {
    ...
    public List<Integer> sort_bfs(Graph graph){
        ...
        for(Graph.Vertex v: graph.vertices.values()){// should iterate inDegreeMap since it contains only degree>0 , iterate from the whole graph
...
//        graph.addEdge(6,7,3);
        ...
        TopologialSort solver = new TopologialSort();
